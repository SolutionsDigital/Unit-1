"""
Project V10     Name : Michael Mathews   Date :  23 /8 / 19
...
Data Sourced and varified  @ http://data.un.org/
"""
...
def capital_game(country, capital):
    ...
    while True:
        ...
        if guess != capital:          
            ...
            print("You are Correct! Nice job. The capital of ",country ,"is ",capital)
            break
...
def report(myCountriesList):
    ...
    print("*************" * 5)
    print('{:7}{:20s}{:<20s}{:>15}'.format("No#", "Country", "Capital", "Population"))
    print("*************" * 5)
...
def addCountryindex(myCountriesList):
    ...
    newCaptital = input("What is the new Captial name : ")
    newPopulation = int(input("What is the new Population : "))
    myCountriesList.insert(newindex-1,[newCountry, newCaptital, newPopulation])
...
def changeCountry(myCountriesList):
    ...
    print()
    print("index -", updateindex, " ", myCountriesList[updateindex - 1], "has been updated to ", updateCountry)
...
def loginform():
    ...
    while pwcount < 4:
        ...
        if password != "p":
            ...
            legal = True
            print("Access confirmed for", username, " - Data sourced @ http://data.un.org/")
            break
...
##        print(populations)
        ...
        showOptions()
        userSelection = input("CheckData @ http://data.un.org/    Select your OPTION : ")
